...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-dzua3_se#no4rw+kh9m^*_)&2f+^*^@88k_snnwxw76u=b==ag')
...
if not DEBUG:
    ...
    X_FRAME_OPTIONS = 'SAMEORIGIN'  # Temporarily changed from DENY for screenshot tools
